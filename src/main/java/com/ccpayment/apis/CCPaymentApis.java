...
public final class CCPaymentApis {
    ...
    public static CCPaymentApis getInstance(String appId, String secret){
        CCPaymentApis api = new CCPaymentApis();
        api.appId = appId;
     ...
     * @throws Exception
     */
    public CreateOrderResponse createOrder(CreateOrderParam param) throws Exception {
     ...
     * @throws Exception
     */
    public GetSupportTokenResponse getSupportToken() throws Exception {
     ...
     * @throws Exception
     */
    public GetSupportCoinResponse getSupportCoin() throws Exception {
     ...
     * @throws Exception
     */
    public CheckoutUrlResponse checkoutUrl(CheckoutUrlParam param) throws Exception {
     ...
     * @throws Exception
     */
    public GetTokenChainResponse getTokenChain(GetTokenChainParam param) throws Exception {
     ...
     * @throws Exception
     */
    public GetTokenRateResponse getTokenRate(GetTokenRateParam param) throws Exception {
     ...
     * @throws Exception
     */
    public WithdrawResponse withdraw(WithdrawParam param) throws Exception {
     ...
     * @throws Exception
     */
    public CheckUserResponse checkUser(CheckUserParam param) throws Exception {
     ...
     * @throws Exception
     */
    public AssetsResponse assets(AssetsParam param) throws Exception {
     ...
     * @throws Exception
     */
    public NetworkFeeResponse networkFee(NetworkFeeParam param) throws Exception {
     ...
     * @throws Exception
     */
    public OrderInfoResponse[] orderInfo(OrderInfoParam param) throws Exception {
     ...
     * @throws Exception
     */
    public PaymentAddressResponse paymentAddress(PaymentAddressParam param) throws Exception {
     ...
     * @throws Exception
     */
    public GetChainHeightInfoResponse[] getChainHeightInfo() throws Exception {
     ...
     */
    public CallbackData callback(String callbackData, String appId, long timestamp, String sign) throws Exception {
     ...
     */
    private String getSign(String data, String timestamp) throws NoSuchAlgorithmException {
        String originStr = String.format("%s%s%s%s", this.appId, this.appSecret, timestamp, data);
     ...
     * @throws Exception
     */
    protected <T> T doSend(String api, Object params, Class<T> resp) throws Exception {
        ...
        post.addHeader(Config.HeaderAppId, this.appId);
